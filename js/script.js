...
const dopInfoImg = document.querySelectorAll('.product_img');

dopInfoImg.forEach(function(item){
  item.addEventListener("mouseover", function(item){
    this.classList.add("active");
...
const dopInfo = document.querySelectorAll('.product_item_info');

dopInfo.forEach(function(item){
  item.addEventListener("mouseover", function(item){
    this.classList.add("active");
    this.nextElementSibling.classList.add("active");
  })
